...
function annoyingSong(countdown){
  for(let i = countdown; i > 0; i --) {
    return `${countdown} bottles of soda on the wall. ${countdown} bottles of soda, take one down pass it around ${i - 1} bottles of soda on the wall `
  }
}
